...
class RichiestaPrenotazione(BaseModel):
    ...
    # Per compatibilità: nel vecchio c’era "sede". Qui la ignoriamo ma la accettiamo.
    sede: Optional[str] = ""

    data: str
    orario: str
    persone: Union[int, str] = Field(...)
    seggiolini: Union[int, str] = 0  # 0..5
    ...
    def _coerce_fields(cls, values: Any) -> Any:
        ...
        # sede: se arriva, la ignoriamo; forziamo sede unica a runtime
        return values
